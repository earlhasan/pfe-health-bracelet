...
import 'schema/diabete_record.dart';
...
export 'schema/diabete_record.dart';
...
/// Functions to query DiabeteRecords (as a Stream and as a Future).
Future<int> queryDiabeteRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DiabeteRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DiabeteRecord>> queryDiabeteRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DiabeteRecord.collection,
      DiabeteRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DiabeteRecord>> queryDiabeteRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
